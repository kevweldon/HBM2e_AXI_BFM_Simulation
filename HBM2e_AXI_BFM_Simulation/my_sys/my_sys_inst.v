	my_sys u0 (
		...
		.hbm_reset_in_reset                      (_connected_to_hbm_reset_in_reset_),                      //   input,  width = 1,          hbm_reset_in.reset
		...
		.hbm_wmcrst_n_reset_n                    (_connected_to_hbm_wmcrst_n_reset_n_),                    //  output,  width = 1,          hbm_wmcrst_n.reset_n
