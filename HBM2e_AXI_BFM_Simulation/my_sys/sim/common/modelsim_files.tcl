...
source [file join [file dirname [info script]] ./../../../ip/my_sys/my_sys_intel_noc_initiator_0/sim/common/modelsim_files.tcl]
...
namespace eval my_sys {
  proc get_design_libraries {} {
    ...
    set libraries [dict merge $libraries [my_sys_intel_noc_initiator_0::get_design_libraries]]
  ...
  proc get_memory_files {QSYS_SIMDIR} {
    ...
    set memory_files [concat $memory_files [my_sys_intel_noc_initiator_0::get_memory_files "$QSYS_SIMDIR/../../ip/my_sys/my_sys_intel_noc_initiator_0/sim/"]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [my_sys_intel_noc_initiator_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/my_sys/my_sys_intel_noc_initiator_0/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [my_sys_intel_noc_initiator_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/my_sys/my_sys_intel_noc_initiator_0/sim/"]]
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/my_sys_altera_mm_interconnect_1920_5ioayuq.v"]\"  -work altera_mm_interconnect_1920"                       
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/my_sys_altera_mm_interconnect_1920_dxipmqi.v"]\"  -work altera_mm_interconnect_1920"                       
  ...
  proc get_elab_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append ELAB_OPTIONS [my_sys_intel_noc_initiator_0::get_elab_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_sim_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append SIM_OPTIONS [my_sys_intel_noc_initiator_0::get_sim_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_env_variables {SIMULATOR_TOOL_BITNESS} {
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [my_sys_intel_noc_initiator_0::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
