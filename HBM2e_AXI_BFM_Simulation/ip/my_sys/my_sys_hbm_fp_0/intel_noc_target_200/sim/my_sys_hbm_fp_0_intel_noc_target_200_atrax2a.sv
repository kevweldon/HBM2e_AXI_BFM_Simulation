...
module my_sys_hbm_fp_0_intel_noc_target_200_atrax2a # (
 ...
 if (CHOOSE_AXI=="AXI4") begin : target_0
    ...
    (* altera_attribute = {"-name PRESERVE_FANOUT_FREE_WYSIWYG ON; -name NOC_TARGET ON; -name NOC_TARGET_ADDRESS_RANGE 30"} *) tennm_noc_target # (
    ...
    (* altera_attribute = {"-name PRESERVE_FANOUT_FREE_WYSIWYG ON; -name NOC_TARGET ON; -name NOC_TARGET_ADDRESS_RANGE 30; -name AXI_LITE_NOC_BRIDGE ON"} *) tennm_noc_axilite_target # (
    .NOC_TARGET_ECC_EN (NOC_TARGET_ECC_EN),
    .NOC_SECURE_FILTER_ENA (NOC_SECURE_FILTER_ENA),
    .NOC_TARGET_DFD_EN(NOC_TARGET_DFD_EN),
