	component my_sys_intel_noc_initiator_1 is
		port (
	...
	end component my_sys_intel_noc_initiator_1;

	u0 : component my_sys_intel_noc_initiator_1
		port map (
			s0_axi4_awid    => CONNECTED_TO_s0_axi4_awid,    --        s0_axi4.awid
			...
			s1_axi4_awid    => CONNECTED_TO_s1_axi4_awid,    --        s1_axi4.awid
			...
			s1_axi4_arid    => CONNECTED_TO_s1_axi4_arid,    --               .arid
